...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState('test'); // 'test', 'landing', 'app'
  ...
  const goToApp = () => {
    console.log('Navigating to AI Notes App');  
    setCurrentView('app');
  };

  const goBackToTest = () => {
    console.log('Going back to test view');
    setCurrentView('test');
  };
  ...
  if (currentView === 'landing') {
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
        ...
        <LandingPageFixed onStartCreating={goToApp} />
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      <button
        onClick={() => {
          console.log('Loading AI Notes App...');
          goToLanding(); // First go to landing page
        }}
        style={{
          marginTop: '20px',
          padding: '15px 30px',
      ...
      <button
        onClick={() => {
          console.log('Loading AI Notes App directly...');
          goToApp(); // Direct to app
        }}
        style={{
          marginTop: '10px',
          padding: '10px 20px',
